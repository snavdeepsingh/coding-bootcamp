...
5. Ensure that your `package.json` file is set up correctly. It must have a `start` script and all dependencies defined.
Use `cat package.json` to display the json dataE.g.:
   ```json
   {
     "name": "starwars",
     "version": "1.0.0",
